...
namespace PdfGenerator
{
    public class Program
    {
        ...
        //private static readonly string templatePath_Pdf = System.IO.Path.Combine(new FileInfo(Assembly.GetExecutingAssembly().Location).Directory.FullName, "Assets", $"ReportTemplate.pdf");
        ...
        public static async Task Main(string[] args)
        {
            ...
            ////var result = ExportDemo.ExportDocxByObject(templatePath_Pdf, docinfo);
            ...
            //Export_QuestPDF exporter_QuestPDF = new Export_QuestPDF();
            //Export_PdfSharpCore exporter_PdfSharpCore = new Export_PdfSharpCore();

            Export_MigraDocCore exporter_MigraDocCore = new Export_MigraDocCore();
        }
